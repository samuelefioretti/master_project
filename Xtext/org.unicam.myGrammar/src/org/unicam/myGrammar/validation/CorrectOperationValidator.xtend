 ...
 * 		OptGrammarPackage.Literals.ARRAY_DEFINITION__OPERATOR);
 * }
 ...
 * 		error("You must use '=' here.", OptGrammarPackage.Literals.PRIMARY_TYPE_DEFINITION_DECLARATION__OPERATOR)
 * 		return;
 * 	}
 ...
 * 			OptGrammarPackage.Literals.PRIMARY_TYPE_DEFINITION_DECLARATION__OPERATOR
 * 		);
 * }
 ...
 * 			(dec.first !== null)
 * 				? OptGrammarPackage.Literals.SINGLE_DEFINITION__FIRST
 * 				: OptGrammarPackage.Literals.SINGLE_DEFINITION__SECOND
 * 		);
 * }
 ...
 * 				obj.ref !== null ? obj.ref.asDeclaration.name.equals(name) : obj.asDeclaration.name.equals(name) &&
 * 					obj.value !== null
 * 			default:
 * 				false
 * 		}
