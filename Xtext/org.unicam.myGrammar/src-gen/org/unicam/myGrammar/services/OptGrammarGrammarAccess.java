...
public class OptGrammarGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cPragmaDirectiveAssignment_0 = (Assignment)cAlternatives.eContents().get(0);
		private final RuleCall cPragmaDirectivePragmaDirectiveParserRuleCall_0_0 = (RuleCall)cPragmaDirectiveAssignment_0.eContents().get(0);
		private final Assignment cImportDirectiveAssignment_1 = (Assignment)cAlternatives.eContents().get(1);
		private final RuleCall cImportDirectiveImportDirectiveParserRuleCall_1_0 = (RuleCall)cImportDirectiveAssignment_1.eContents().get(0);
		private final Assignment cContractAssignment_2 = (Assignment)cAlternatives.eContents().get(2);
		private final RuleCall cContractContractParserRuleCall_2_0 = (RuleCall)cContractAssignment_2.eContents().get(0);
		
		//Model:
		//	(pragmaDirective+=PragmaDirective | importDirective+=ImportDirective | contract+=Contract)*;
		...
		public Assignment getPragmaDirectiveAssignment_0() { return cPragmaDirectiveAssignment_0; }
		
		//PragmaDirective
		public RuleCall getPragmaDirectivePragmaDirectiveParserRuleCall_0_0() { return cPragmaDirectivePragmaDirectiveParserRuleCall_0_0; }
		
		//importDirective+=ImportDirective
		public Assignment getImportDirectiveAssignment_1() { return cImportDirectiveAssignment_1; }
		
		//ImportDirective
		public RuleCall getImportDirectiveImportDirectiveParserRuleCall_1_0() { return cImportDirectiveImportDirectiveParserRuleCall_1_0; }
		
		//contract+=Contract
		public Assignment getContractAssignment_2() { return cContractAssignment_2; }
		
		//Contract
		public RuleCall getContractContractParserRuleCall_2_0() { return cContractContractParserRuleCall_2_0; }
	}
	public class PragmaDirectiveElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.PragmaDirective");
		...
		private final RuleCall cVersionVersionOperatorParserRuleCall_3_0 = (RuleCall)cVersionAssignment_3.eContents().get(0);
		private final Keyword cDigitZeroFullStopDigitFiveFullStopDigitTwoKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//versionOperator
		public RuleCall getVersionVersionOperatorParserRuleCall_3_0() { return cVersionVersionOperatorParserRuleCall_3_0; }
		
		//"0.5.2"
		public Keyword getDigitZeroFullStopDigitFiveFullStopDigitTwoKeyword_4() { return cDigitZeroFullStopDigitFiveFullStopDigitTwoKeyword_4; }
		
		//";"
		public Keyword getSemicolonKeyword_5() { return cSemicolonKeyword_5; }
	}
	public class VersionOperatorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.versionOperator");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cValueAlternatives_0 = (Alternatives)cValueAssignment.eContents().get(0);
		private final Keyword cValueCircumflexAccentKeyword_0_0 = (Keyword)cValueAlternatives_0.eContents().get(0);
		private final Keyword cValueTildeKeyword_0_1 = (Keyword)cValueAlternatives_0.eContents().get(1);
		private final Keyword cValueGreaterThanSignEqualsSignKeyword_0_2 = (Keyword)cValueAlternatives_0.eContents().get(2);
		private final Keyword cValueGreaterThanSignKeyword_0_3 = (Keyword)cValueAlternatives_0.eContents().get(3);
		private final Keyword cValueLessThanSignKeyword_0_4 = (Keyword)cValueAlternatives_0.eContents().get(4);
		private final Keyword cValueLessThanSignEqualsSignKeyword_0_5 = (Keyword)cValueAlternatives_0.eContents().get(5);
		...
		//"^"
		public Keyword getValueCircumflexAccentKeyword_0_0() { return cValueCircumflexAccentKeyword_0_0; }
		
		//"~"
		public Keyword getValueTildeKeyword_0_1() { return cValueTildeKeyword_0_1; }
		
		//">="
		public Keyword getValueGreaterThanSignEqualsSignKeyword_0_2() { return cValueGreaterThanSignEqualsSignKeyword_0_2; }
		
		//">"
		public Keyword getValueGreaterThanSignKeyword_0_3() { return cValueGreaterThanSignKeyword_0_3; }
		
		//"<"
		public Keyword getValueLessThanSignKeyword_0_4() { return cValueLessThanSignKeyword_0_4; }
		
		//"<="
		public Keyword getValueLessThanSignEqualsSignKeyword_0_5() { return cValueLessThanSignEqualsSignKeyword_0_5; }
	...
	public class DefinitionBodyElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cConstructorDefinitionParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cFunctionDefinitionParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		private final RuleCall cStructDefinitionParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		private final RuleCall cEnumDefinitionParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final Group cGroup_4 = (Group)cAlternatives.eContents().get(4);
		private final RuleCall cPrimaryTypeDefinitionDeclarationParserRuleCall_4_0 = (RuleCall)cGroup_4.eContents().get(0);
		private final Keyword cSemicolonKeyword_4_1 = (Keyword)cGroup_4.eContents().get(1);
		private final RuleCall cModifierParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		...
		public RuleCall getConstructorDefinitionParserRuleCall_0() { return cConstructorDefinitionParserRuleCall_0; }
		
		//FunctionDefinition
		public RuleCall getFunctionDefinitionParserRuleCall_1() { return cFunctionDefinitionParserRuleCall_1; }
		
		//StructDefinition
		public RuleCall getStructDefinitionParserRuleCall_2() { return cStructDefinitionParserRuleCall_2; }
		
		//EnumDefinition
		public RuleCall getEnumDefinitionParserRuleCall_3() { return cEnumDefinitionParserRuleCall_3; }
		
		//PrimaryTypeDefinitionDeclaration ";"
		public Group getGroup_4() { return cGroup_4; }
		
		//PrimaryTypeDefinitionDeclaration
		public RuleCall getPrimaryTypeDefinitionDeclarationParserRuleCall_4_0() { return cPrimaryTypeDefinitionDeclarationParserRuleCall_4_0; }
		
		//";"
		public Keyword getSemicolonKeyword_4_1() { return cSemicolonKeyword_4_1; }
		
		//Modifier
		public RuleCall getModifierParserRuleCall_5() { return cModifierParserRuleCall_5; }
		
		//Event
		public RuleCall getEventParserRuleCall_6() { return cEventParserRuleCall_6; }
	}
	public class ConstructorDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.ConstructorDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cStateAssignment_2_0 = (Assignment)cAlternatives_2.eContents().get(0);
		private final RuleCall cStateStateMutabilityParserRuleCall_2_0_0 = (RuleCall)cStateAssignment_2_0.eContents().get(0);
		private final Assignment cConstAssignment_2_1 = (Assignment)cAlternatives_2.eContents().get(1);
		private final RuleCall cConstConstParserRuleCall_2_1_0 = (RuleCall)cConstAssignment_2_1.eContents().get(0);
		private final Assignment cModifierAssignment_2_2 = (Assignment)cAlternatives_2.eContents().get(2);
		private final RuleCall cModifierModifierInvocationParserRuleCall_2_2_0 = (RuleCall)cModifierAssignment_2_2.eContents().get(0);
		private final Assignment cVisibilityAssignment_2_3 = (Assignment)cAlternatives_2.eContents().get(3);
		private final RuleCall cVisibilityVisibilityLiteralParserRuleCall_2_3_0 = (RuleCall)cVisibilityAssignment_2_3.eContents().get(0);
		private final Alternatives cAlternatives_3 = (Alternatives)cGroup.eContents().get(3);
		private final Assignment cBlockAssignment_3_0 = (Assignment)cAlternatives_3.eContents().get(0);
		private final RuleCall cBlockBodyParserRuleCall_3_0_0 = (RuleCall)cBlockAssignment_3_0.eContents().get(0);
		private final Keyword cSemicolonKeyword_3_1 = (Keyword)cAlternatives_3.eContents().get(1);
		
		//ConstructorDefinition:
		//	"constructor" parameters=ParameterList (state+=StateMutability | const+=Const | modifier+=ModifierInvocation |
		...
		//(state+=StateMutability | const+=Const | modifier+=ModifierInvocation | visibility+=VisibilityLiteral)*
		...
		//StateMutability
		public RuleCall getStateStateMutabilityParserRuleCall_2_0_0() { return cStateStateMutabilityParserRuleCall_2_0_0; }
		
		//const+=Const
		public Assignment getConstAssignment_2_1() { return cConstAssignment_2_1; }
		
		//Const
		public RuleCall getConstConstParserRuleCall_2_1_0() { return cConstConstParserRuleCall_2_1_0; }
		
		//modifier+=ModifierInvocation
		public Assignment getModifierAssignment_2_2() { return cModifierAssignment_2_2; }
		
		//ModifierInvocation
		public RuleCall getModifierModifierInvocationParserRuleCall_2_2_0() { return cModifierModifierInvocationParserRuleCall_2_2_0; }
		
		//visibility+=VisibilityLiteral
		public Assignment getVisibilityAssignment_2_3() { return cVisibilityAssignment_2_3; }
		
		//VisibilityLiteral
		public RuleCall getVisibilityVisibilityLiteralParserRuleCall_2_3_0() { return cVisibilityVisibilityLiteralParserRuleCall_2_3_0; }
		...
		//Body
		public RuleCall getBlockBodyParserRuleCall_3_0_0() { return cBlockBodyParserRuleCall_3_0_0; }
	...
	public class FunctionDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cStateStateMutabilityParserRuleCall_4_0_0 = (RuleCall)cStateAssignment_4_0.eContents().get(0);
		private final Assignment cConstAssignment_4_1 = (Assignment)cAlternatives_4.eContents().get(1);
		private final RuleCall cConstConstParserRuleCall_4_1_0 = (RuleCall)cConstAssignment_4_1.eContents().get(0);
		private final Assignment cModifierAssignment_4_2 = (Assignment)cAlternatives_4.eContents().get(2);
		private final RuleCall cModifierModifierInvocationParserRuleCall_4_2_0 = (RuleCall)cModifierAssignment_4_2.eContents().get(0);
		private final Assignment cVisibilityAssignment_4_3 = (Assignment)cAlternatives_4.eContents().get(3);
		private final RuleCall cVisibilityVisibilityLiteralParserRuleCall_4_3_0 = (RuleCall)cVisibilityAssignment_4_3.eContents().get(0);
		...
		//StateMutability
		public RuleCall getStateStateMutabilityParserRuleCall_4_0_0() { return cStateStateMutabilityParserRuleCall_4_0_0; }
		
		//const+=Const
		public Assignment getConstAssignment_4_1() { return cConstAssignment_4_1; }
		
		//Const
		public RuleCall getConstConstParserRuleCall_4_1_0() { return cConstConstParserRuleCall_4_1_0; }
		
		//modifier+=ModifierInvocation
		public Assignment getModifierAssignment_4_2() { return cModifierAssignment_4_2; }
		
		//ModifierInvocation
		public RuleCall getModifierModifierInvocationParserRuleCall_4_2_0() { return cModifierModifierInvocationParserRuleCall_4_2_0; }
		
		//visibility+=VisibilityLiteral
		public Assignment getVisibilityAssignment_4_3() { return cVisibilityAssignment_4_3; }
		
		//VisibilityLiteral
		public RuleCall getVisibilityVisibilityLiteralParserRuleCall_4_3_0() { return cVisibilityVisibilityLiteralParserRuleCall_4_3_0; }
	...
	public class StructDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMembersPrimaryTypeDefinitionDeclarationParserRuleCall_3_0_0 = (RuleCall)cMembersAssignment_3_0.eContents().get(0);
		...
		//(members+=PrimaryTypeDefinitionDeclaration ";")*
		...
		//PrimaryTypeDefinitionDeclaration
		public RuleCall getMembersPrimaryTypeDefinitionDeclarationParserRuleCall_3_0_0() { return cMembersPrimaryTypeDefinitionDeclarationParserRuleCall_3_0_0; }
	...
	public class NonArrayableDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cLocationLocationLiteralParserRuleCall_0_0 = (RuleCall)cLocationAssignment_0.eContents().get(0);
		...
		private final RuleCall cVisibilityVisibilityLiteralParserRuleCall_2_0 = (RuleCall)cVisibilityAssignment_2.eContents().get(0);
		...
		//LocationLiteral
		public RuleCall getLocationLocationLiteralParserRuleCall_0_0() { return cLocationLocationLiteralParserRuleCall_0_0; }
		...
		//VisibilityLiteral
		public RuleCall getVisibilityVisibilityLiteralParserRuleCall_2_0() { return cVisibilityVisibilityLiteralParserRuleCall_2_0; }
	...
	public class ArrayableDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cVisibilityVisibilityLiteralParserRuleCall_1_0 = (RuleCall)cVisibilityAssignment_1.eContents().get(0);
		private final Assignment cTypeAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cTypeSizedDeclarationParserRuleCall_2_0 = (RuleCall)cTypeAssignment_2.eContents().get(0);
		...
		//VisibilityLiteral
		public RuleCall getVisibilityVisibilityLiteralParserRuleCall_1_0() { return cVisibilityVisibilityLiteralParserRuleCall_1_0; }
		
		//type=SizedDeclaration
		public Assignment getTypeAssignment_2() { return cTypeAssignment_2; }
		
		//SizedDeclaration
		public RuleCall getTypeSizedDeclarationParserRuleCall_2_0() { return cTypeSizedDeclarationParserRuleCall_2_0; }
	...
	public class VisibilitySpecifierElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cVisibilityVisibilityLiteralParserRuleCall_0 = (RuleCall)cVisibilityAssignment.eContents().get(0);
		...
		//VisibilityLiteral
		public RuleCall getVisibilityVisibilityLiteralParserRuleCall_0() { return cVisibilityVisibilityLiteralParserRuleCall_0; }
	}
	...
	public class LocationSpecifierElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cLocationLocationLiteralParserRuleCall_0 = (RuleCall)cLocationAssignment.eContents().get(0);
		...
		//LocationLiteral
		public RuleCall getLocationLocationLiteralParserRuleCall_0() { return cLocationLocationLiteralParserRuleCall_0; }
	}
	...
	public class NamedTypeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSizedDeclarationParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//SizedDeclaration
		public RuleCall getSizedDeclarationParserRuleCall_1() { return cSizedDeclarationParserRuleCall_1; }
	}
	public class StandardTypeElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		private final RuleCall cNamedTypeParserRuleCall_0_0 = (RuleCall)cGroup_0.eContents().get(0);
		private final Assignment cDimensionAssignment_0_1 = (Assignment)cGroup_0.eContents().get(1);
		private final RuleCall cDimensionArrayTypeParserRuleCall_0_1_0 = (RuleCall)cDimensionAssignment_0_1.eContents().get(0);
		...
		//NamedType dimension=ArrayType?
		public Group getGroup_0() { return cGroup_0; }
		
		//NamedType
		public RuleCall getNamedTypeParserRuleCall_0_0() { return cNamedTypeParserRuleCall_0_0; }
		
		//dimension=ArrayType?
		public Assignment getDimensionAssignment_0_1() { return cDimensionAssignment_0_1; }
		
		//ArrayType
		public RuleCall getDimensionArrayTypeParserRuleCall_0_1_0() { return cDimensionArrayTypeParserRuleCall_0_1_0; }
	...
	public class ArrayTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.ArrayType");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cLeftSquareBracketKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Action cArrayTypeAction_1 = (Action)cGroup.eContents().get(1);
		...
		//{ArrayType}
		public Action getArrayTypeAction_1() { return cArrayTypeAction_1; }
	...
	public class MappingElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cKeyTypeSizedDeclarationParserRuleCall_2_0 = (RuleCall)cKeyTypeAssignment_2.eContents().get(0);
		...
		//keyType=SizedDeclaration
		public Assignment getKeyTypeAssignment_2() { return cKeyTypeAssignment_2; }
		
		//SizedDeclaration
		public RuleCall getKeyTypeSizedDeclarationParserRuleCall_2_0() { return cKeyTypeSizedDeclarationParserRuleCall_2_0; }
	...
	public class TupleElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_0_0 = (Keyword)cGroup_0.eContents().get(0);
		private final Action cTupleAction_0_1 = (Action)cGroup_0.eContents().get(1);
		private final Group cGroup_0_2 = (Group)cGroup_0.eContents().get(2);
		private final Assignment cMembersAssignment_0_2_0 = (Assignment)cGroup_0_2.eContents().get(0);
		private final RuleCall cMembersExpressionParserRuleCall_0_2_0_0 = (RuleCall)cMembersAssignment_0_2_0.eContents().get(0);
		private final Group cGroup_0_2_1 = (Group)cGroup_0_2.eContents().get(1);
		private final Assignment cMembersAssignment_0_2_1_0 = (Assignment)cGroup_0_2_1.eContents().get(0);
		private final RuleCall cMembersTupleSeparatorParserRuleCall_0_2_1_0_0 = (RuleCall)cMembersAssignment_0_2_1_0.eContents().get(0);
		private final Assignment cMembersAssignment_0_2_1_1 = (Assignment)cGroup_0_2_1.eContents().get(1);
		private final RuleCall cMembersExpressionParserRuleCall_0_2_1_1_0 = (RuleCall)cMembersAssignment_0_2_1_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_0_3 = (Keyword)cGroup_0.eContents().get(3);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Keyword cLeftSquareBracketKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Action cTupleAction_1_1 = (Action)cGroup_1.eContents().get(1);
		private final Group cGroup_1_2 = (Group)cGroup_1.eContents().get(2);
		private final Assignment cMembersAssignment_1_2_0 = (Assignment)cGroup_1_2.eContents().get(0);
		private final RuleCall cMembersExpressionParserRuleCall_1_2_0_0 = (RuleCall)cMembersAssignment_1_2_0.eContents().get(0);
		private final Group cGroup_1_2_1 = (Group)cGroup_1_2.eContents().get(1);
		private final Assignment cMembersAssignment_1_2_1_0 = (Assignment)cGroup_1_2_1.eContents().get(0);
		private final RuleCall cMembersTupleSeparatorParserRuleCall_1_2_1_0_0 = (RuleCall)cMembersAssignment_1_2_1_0.eContents().get(0);
		private final Assignment cMembersAssignment_1_2_1_1 = (Assignment)cGroup_1_2_1.eContents().get(1);
		private final RuleCall cMembersExpressionParserRuleCall_1_2_1_1_0 = (RuleCall)cMembersAssignment_1_2_1_1.eContents().get(0);
		...
		//{Tuple}
		public Action getTupleAction_0_1() { return cTupleAction_0_1; }
		
		//(members+=Expression? (members+=TupleSeparator members+=Expression?)+)?
		public Group getGroup_0_2() { return cGroup_0_2; }
		
		//members+=Expression?
		public Assignment getMembersAssignment_0_2_0() { return cMembersAssignment_0_2_0; }
		
		//Expression
		public RuleCall getMembersExpressionParserRuleCall_0_2_0_0() { return cMembersExpressionParserRuleCall_0_2_0_0; }
		
		//(members+=TupleSeparator members+=Expression?)+
		public Group getGroup_0_2_1() { return cGroup_0_2_1; }
		
		//members+=TupleSeparator
		public Assignment getMembersAssignment_0_2_1_0() { return cMembersAssignment_0_2_1_0; }
		
		//TupleSeparator
		public RuleCall getMembersTupleSeparatorParserRuleCall_0_2_1_0_0() { return cMembersTupleSeparatorParserRuleCall_0_2_1_0_0; }
		
		//members+=Expression?
		public Assignment getMembersAssignment_0_2_1_1() { return cMembersAssignment_0_2_1_1; }
		
		//Expression
		public RuleCall getMembersExpressionParserRuleCall_0_2_1_1_0() { return cMembersExpressionParserRuleCall_0_2_1_1_0; }
		...
		//{Tuple}
		public Action getTupleAction_1_1() { return cTupleAction_1_1; }
		
		//(members+=Expression (members+=TupleSeparator members+=Expression)+)?
		public Group getGroup_1_2() { return cGroup_1_2; }
		
		//members+=Expression
		public Assignment getMembersAssignment_1_2_0() { return cMembersAssignment_1_2_0; }
		
		//Expression
		public RuleCall getMembersExpressionParserRuleCall_1_2_0_0() { return cMembersExpressionParserRuleCall_1_2_0_0; }
		
		//(members+=TupleSeparator members+=Expression)+
		public Group getGroup_1_2_1() { return cGroup_1_2_1; }
		
		//members+=TupleSeparator
		public Assignment getMembersAssignment_1_2_1_0() { return cMembersAssignment_1_2_1_0; }
		
		//TupleSeparator
		public RuleCall getMembersTupleSeparatorParserRuleCall_1_2_1_0_0() { return cMembersTupleSeparatorParserRuleCall_1_2_1_0_0; }
		
		//members+=Expression
		public Assignment getMembersAssignment_1_2_1_1() { return cMembersAssignment_1_2_1_1; }
		
		//Expression
		public RuleCall getMembersExpressionParserRuleCall_1_2_1_1_0() { return cMembersExpressionParserRuleCall_1_2_1_1_0; }
	...
	public class ParameterListElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cParametersPrimaryTypeDefinitionDeclarationParserRuleCall_2_0_0 = (RuleCall)cParametersAssignment_2_0.eContents().get(0);
		private final Group cGroup_2_1 = (Group)cGroup_2.eContents().get(1);
		private final Keyword cCommaKeyword_2_1_0 = (Keyword)cGroup_2_1.eContents().get(0);
		private final Assignment cParametersAssignment_2_1_1 = (Assignment)cGroup_2_1.eContents().get(1);
		private final RuleCall cParametersPrimaryTypeDefinitionDeclarationParserRuleCall_2_1_1_0 = (RuleCall)cParametersAssignment_2_1_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		...
		//"(" {ParameterList} (parameters+=PrimaryTypeDefinitionDeclaration ("," parameters+=PrimaryTypeDefinitionDeclaration)*)?
		//")"
		public Group getGroup() { return cGroup; }
		...
		//(parameters+=PrimaryTypeDefinitionDeclaration ("," parameters+=PrimaryTypeDefinitionDeclaration)*)?
		public Group getGroup_2() { return cGroup_2; }
		...
		//PrimaryTypeDefinitionDeclaration
		public RuleCall getParametersPrimaryTypeDefinitionDeclarationParserRuleCall_2_0_0() { return cParametersPrimaryTypeDefinitionDeclarationParserRuleCall_2_0_0; }
		...
		//PrimaryTypeDefinitionDeclaration
		public RuleCall getParametersPrimaryTypeDefinitionDeclarationParserRuleCall_2_1_1_0() { return cParametersPrimaryTypeDefinitionDeclarationParserRuleCall_2_1_1_0; }
	...
	public class StatementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDoWhileStatementParserRuleCall_3_0 = (RuleCall)cAlternatives_3.eContents().get(0);
		private final RuleCall cContinueStatementParserRuleCall_3_1 = (RuleCall)cAlternatives_3.eContents().get(1);
		private final RuleCall cBreakStatementParserRuleCall_3_2 = (RuleCall)cAlternatives_3.eContents().get(2);
		private final RuleCall cReturnStatementParserRuleCall_3_3 = (RuleCall)cAlternatives_3.eContents().get(3);
		private final RuleCall cThrowStatementParserRuleCall_3_4 = (RuleCall)cAlternatives_3.eContents().get(4);
		private final RuleCall cDeleteStatementParserRuleCall_3_5 = (RuleCall)cAlternatives_3.eContents().get(5);
		private final RuleCall cSimpleStatementParserRuleCall_3_6 = (RuleCall)cAlternatives_3.eContents().get(6);
		private final RuleCall cEmitStatementParserRuleCall_3_7 = (RuleCall)cAlternatives_3.eContents().get(7);
		...
		//LoopStructures | Body | PlaceHolderStatement | (DoWhileStatement | ContinueStatement | BreakStatement | ReturnStatement
		//| ThrowStatement | DeleteStatement | SimpleStatement | EmitStatement)
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//(DoWhileStatement | ContinueStatement | BreakStatement | ReturnStatement | ThrowStatement | DeleteStatement |
		//SimpleStatement | EmitStatement)
		public Alternatives getAlternatives_3() { return cAlternatives_3; }
		
		//DoWhileStatement
		public RuleCall getDoWhileStatementParserRuleCall_3_0() { return cDoWhileStatementParserRuleCall_3_0; }
		
		//ContinueStatement
		public RuleCall getContinueStatementParserRuleCall_3_1() { return cContinueStatementParserRuleCall_3_1; }
		
		//BreakStatement
		public RuleCall getBreakStatementParserRuleCall_3_2() { return cBreakStatementParserRuleCall_3_2; }
		
		//ReturnStatement
		public RuleCall getReturnStatementParserRuleCall_3_3() { return cReturnStatementParserRuleCall_3_3; }
		
		//ThrowStatement
		public RuleCall getThrowStatementParserRuleCall_3_4() { return cThrowStatementParserRuleCall_3_4; }
		
		//DeleteStatement
		public RuleCall getDeleteStatementParserRuleCall_3_5() { return cDeleteStatementParserRuleCall_3_5; }
		
		//SimpleStatement
		public RuleCall getSimpleStatementParserRuleCall_3_6() { return cSimpleStatementParserRuleCall_3_6; }
		
		//EmitStatement
		public RuleCall getEmitStatementParserRuleCall_3_7() { return cEmitStatementParserRuleCall_3_7; }
	}
	public class DoWhileStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.DoWhileStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EmitStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.EmitStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cCallFunctionCallParserRuleCall_1_0 = (RuleCall)cCallAssignment_1.eContents().get(0);
		...
		//FunctionCall
		public RuleCall getCallFunctionCallParserRuleCall_1_0() { return cCallFunctionCallParserRuleCall_1_0; }
	...
	public class WhileStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cTypeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cTypeWhileKeyword_0_0 = (Keyword)cTypeAssignment_0.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cConditionAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cConditionExpressionParserRuleCall_2_0 = (RuleCall)cConditionAssignment_2.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		...
		//"while"
		public Keyword getTypeWhileKeyword_0_0() { return cTypeWhileKeyword_0_0; }
	...
	public class ForStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cTypeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cTypeForKeyword_0_0 = (Keyword)cTypeAssignment_0.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		//"for"
		public Keyword getTypeForKeyword_0_0() { return cTypeForKeyword_0_0; }
	...
	public class PlaceHolderStatementElements extends AbstractParserRuleElementFinder {
		...
		private final Action cPlaceHolderStatementAction_2 = (Action)cGroup.eContents().get(2);
		...
		//{PlaceHolderStatement}
		public Action getPlaceHolderStatementAction_2() { return cPlaceHolderStatementAction_2; }
	}
	...
	public class LiteralElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cBlockhashFunctionParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cGasleftFunctionParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		...
		//Literal:
		//	NumericLiteral | StringLiteral | BooleanLiteral | SpecialLiteral | BlockhashFunction | GasleftFunction |
		...
		//BlockhashFunction
		public RuleCall getBlockhashFunctionParserRuleCall_4() { return cBlockhashFunctionParserRuleCall_4; }
		
		//GasleftFunction
		public RuleCall getGasleftFunctionParserRuleCall_5() { return cGasleftFunctionParserRuleCall_5; }
	...
	public class BooleanLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.BooleanLiteral");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cValueAlternatives_0 = (Alternatives)cValueAssignment.eContents().get(0);
	...
	public class TypeCastElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cValueSizedDeclarationParserRuleCall_0_0 = (RuleCall)cValueAssignment_0.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cExpressionAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cExpressionExpressionParserRuleCall_2_0 = (RuleCall)cExpressionAssignment_2.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		...
		//value=SizedDeclaration
		public Assignment getValueAssignment_0() { return cValueAssignment_0; }
		
		//SizedDeclaration
		public RuleCall getValueSizedDeclarationParserRuleCall_0_0() { return cValueSizedDeclarationParserRuleCall_0_0; }
	...
	public class SizedDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.SizedDeclaration");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final Keyword cTypeBytesKeyword_2_0_0 = (Keyword)cTypeAlternatives_2_0.eContents().get(0);
		private final Keyword cTypeByteKeyword_2_0_1 = (Keyword)cTypeAlternatives_2_0.eContents().get(1);
		private final Keyword cTypeBytes1Keyword_2_0_2 = (Keyword)cTypeAlternatives_2_0.eContents().get(2);
		private final Keyword cTypeBytes2Keyword_2_0_3 = (Keyword)cTypeAlternatives_2_0.eContents().get(3);
		private final Keyword cTypeBytes3Keyword_2_0_4 = (Keyword)cTypeAlternatives_2_0.eContents().get(4);
		private final Keyword cTypeBytes4Keyword_2_0_5 = (Keyword)cTypeAlternatives_2_0.eContents().get(5);
		private final Keyword cTypeBytes5Keyword_2_0_6 = (Keyword)cTypeAlternatives_2_0.eContents().get(6);
		private final Keyword cTypeBytes6Keyword_2_0_7 = (Keyword)cTypeAlternatives_2_0.eContents().get(7);
		private final Keyword cTypeBytes7Keyword_2_0_8 = (Keyword)cTypeAlternatives_2_0.eContents().get(8);
		private final Keyword cTypeBytes8Keyword_2_0_9 = (Keyword)cTypeAlternatives_2_0.eContents().get(9);
		private final Keyword cTypeBytes9Keyword_2_0_10 = (Keyword)cTypeAlternatives_2_0.eContents().get(10);
		private final Keyword cTypeBytes10Keyword_2_0_11 = (Keyword)cTypeAlternatives_2_0.eContents().get(11);
		private final Keyword cTypeBytes11Keyword_2_0_12 = (Keyword)cTypeAlternatives_2_0.eContents().get(12);
		private final Keyword cTypeBytes12Keyword_2_0_13 = (Keyword)cTypeAlternatives_2_0.eContents().get(13);
		private final Keyword cTypeBytes13Keyword_2_0_14 = (Keyword)cTypeAlternatives_2_0.eContents().get(14);
		private final Keyword cTypeBytes14Keyword_2_0_15 = (Keyword)cTypeAlternatives_2_0.eContents().get(15);
		private final Keyword cTypeBytes15Keyword_2_0_16 = (Keyword)cTypeAlternatives_2_0.eContents().get(16);
		private final Keyword cTypeBytes16Keyword_2_0_17 = (Keyword)cTypeAlternatives_2_0.eContents().get(17);
		private final Keyword cTypeBytes17Keyword_2_0_18 = (Keyword)cTypeAlternatives_2_0.eContents().get(18);
		private final Keyword cTypeBytes18Keyword_2_0_19 = (Keyword)cTypeAlternatives_2_0.eContents().get(19);
		private final Keyword cTypeBytes19Keyword_2_0_20 = (Keyword)cTypeAlternatives_2_0.eContents().get(20);
		private final Keyword cTypeBytes20Keyword_2_0_21 = (Keyword)cTypeAlternatives_2_0.eContents().get(21);
		private final Keyword cTypeBytes21Keyword_2_0_22 = (Keyword)cTypeAlternatives_2_0.eContents().get(22);
		private final Keyword cTypeBytes22Keyword_2_0_23 = (Keyword)cTypeAlternatives_2_0.eContents().get(23);
		private final Keyword cTypeBytes23Keyword_2_0_24 = (Keyword)cTypeAlternatives_2_0.eContents().get(24);
		private final Keyword cTypeBytes24Keyword_2_0_25 = (Keyword)cTypeAlternatives_2_0.eContents().get(25);
		private final Keyword cTypeBytes25Keyword_2_0_26 = (Keyword)cTypeAlternatives_2_0.eContents().get(26);
		private final Keyword cTypeBytes26Keyword_2_0_27 = (Keyword)cTypeAlternatives_2_0.eContents().get(27);
		private final Keyword cTypeBytes27Keyword_2_0_28 = (Keyword)cTypeAlternatives_2_0.eContents().get(28);
		private final Keyword cTypeBytes28Keyword_2_0_29 = (Keyword)cTypeAlternatives_2_0.eContents().get(29);
		private final Keyword cTypeBytes29Keyword_2_0_30 = (Keyword)cTypeAlternatives_2_0.eContents().get(30);
		private final Keyword cTypeBytes30Keyword_2_0_31 = (Keyword)cTypeAlternatives_2_0.eContents().get(31);
		private final Keyword cTypeBytes31Keyword_2_0_32 = (Keyword)cTypeAlternatives_2_0.eContents().get(32);
		private final Keyword cTypeBytes32Keyword_2_0_33 = (Keyword)cTypeAlternatives_2_0.eContents().get(33);
		...
		private final RuleCall cTypeFixedParserRuleCall_3_0_3 = (RuleCall)cTypeAlternatives_3_0.eContents().get(3);
		private final RuleCall cTypeUfixedParserRuleCall_3_0_4 = (RuleCall)cTypeAlternatives_3_0.eContents().get(4);
		...
		//"bytes30" | "bytes31" | "bytes32") | type=( // Other
		//"address" | "real" | "ureal" | Fixed | Ufixed)
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//// BYTES
		//"bytes"
		public Keyword getTypeBytesKeyword_2_0_0() { return cTypeBytesKeyword_2_0_0; }
		
		//"byte"
		public Keyword getTypeByteKeyword_2_0_1() { return cTypeByteKeyword_2_0_1; }
		
		//"bytes1"
		public Keyword getTypeBytes1Keyword_2_0_2() { return cTypeBytes1Keyword_2_0_2; }
		
		//"bytes2"
		public Keyword getTypeBytes2Keyword_2_0_3() { return cTypeBytes2Keyword_2_0_3; }
		
		//"bytes3"
		public Keyword getTypeBytes3Keyword_2_0_4() { return cTypeBytes3Keyword_2_0_4; }
		
		//"bytes4"
		public Keyword getTypeBytes4Keyword_2_0_5() { return cTypeBytes4Keyword_2_0_5; }
		
		//"bytes5"
		public Keyword getTypeBytes5Keyword_2_0_6() { return cTypeBytes5Keyword_2_0_6; }
		
		//"bytes6"
		public Keyword getTypeBytes6Keyword_2_0_7() { return cTypeBytes6Keyword_2_0_7; }
		
		//"bytes7"
		public Keyword getTypeBytes7Keyword_2_0_8() { return cTypeBytes7Keyword_2_0_8; }
		
		//"bytes8"
		public Keyword getTypeBytes8Keyword_2_0_9() { return cTypeBytes8Keyword_2_0_9; }
		
		//"bytes9"
		public Keyword getTypeBytes9Keyword_2_0_10() { return cTypeBytes9Keyword_2_0_10; }
		
		//"bytes10"
		public Keyword getTypeBytes10Keyword_2_0_11() { return cTypeBytes10Keyword_2_0_11; }
		
		//"bytes11"
		public Keyword getTypeBytes11Keyword_2_0_12() { return cTypeBytes11Keyword_2_0_12; }
		
		//"bytes12"
		public Keyword getTypeBytes12Keyword_2_0_13() { return cTypeBytes12Keyword_2_0_13; }
		
		//"bytes13"
		public Keyword getTypeBytes13Keyword_2_0_14() { return cTypeBytes13Keyword_2_0_14; }
		
		//"bytes14"
		public Keyword getTypeBytes14Keyword_2_0_15() { return cTypeBytes14Keyword_2_0_15; }
		
		//"bytes15"
		public Keyword getTypeBytes15Keyword_2_0_16() { return cTypeBytes15Keyword_2_0_16; }
		
		//"bytes16"
		public Keyword getTypeBytes16Keyword_2_0_17() { return cTypeBytes16Keyword_2_0_17; }
		
		//"bytes17"
		public Keyword getTypeBytes17Keyword_2_0_18() { return cTypeBytes17Keyword_2_0_18; }
		
		//"bytes18"
		public Keyword getTypeBytes18Keyword_2_0_19() { return cTypeBytes18Keyword_2_0_19; }
		
		//"bytes19"
		public Keyword getTypeBytes19Keyword_2_0_20() { return cTypeBytes19Keyword_2_0_20; }
		
		//"bytes20"
		public Keyword getTypeBytes20Keyword_2_0_21() { return cTypeBytes20Keyword_2_0_21; }
		
		//"bytes21"
		public Keyword getTypeBytes21Keyword_2_0_22() { return cTypeBytes21Keyword_2_0_22; }
		
		//"bytes22"
		public Keyword getTypeBytes22Keyword_2_0_23() { return cTypeBytes22Keyword_2_0_23; }
		
		//"bytes23"
		public Keyword getTypeBytes23Keyword_2_0_24() { return cTypeBytes23Keyword_2_0_24; }
		
		//"bytes24"
		public Keyword getTypeBytes24Keyword_2_0_25() { return cTypeBytes24Keyword_2_0_25; }
		
		//"bytes25"
		public Keyword getTypeBytes25Keyword_2_0_26() { return cTypeBytes25Keyword_2_0_26; }
		
		//"bytes26"
		public Keyword getTypeBytes26Keyword_2_0_27() { return cTypeBytes26Keyword_2_0_27; }
		
		//"bytes27"
		public Keyword getTypeBytes27Keyword_2_0_28() { return cTypeBytes27Keyword_2_0_28; }
		
		//"bytes28"
		public Keyword getTypeBytes28Keyword_2_0_29() { return cTypeBytes28Keyword_2_0_29; }
		
		//"bytes29"
		public Keyword getTypeBytes29Keyword_2_0_30() { return cTypeBytes29Keyword_2_0_30; }
		
		//"bytes30"
		public Keyword getTypeBytes30Keyword_2_0_31() { return cTypeBytes30Keyword_2_0_31; }
		
		//"bytes31"
		public Keyword getTypeBytes31Keyword_2_0_32() { return cTypeBytes31Keyword_2_0_32; }
		...
		//Fixed
		public RuleCall getTypeFixedParserRuleCall_3_0_3() { return cTypeFixedParserRuleCall_3_0_3; }
		
		//Ufixed
		public RuleCall getTypeUfixedParserRuleCall_3_0_4() { return cTypeUfixedParserRuleCall_3_0_4; }
	}
	...
	public class FixedElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.Fixed");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cFixedKeyword_0 = (Keyword)cAlternatives.eContents().get(0);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Keyword cFixedKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final RuleCall cVALUETerminalRuleCall_1_1 = (RuleCall)cGroup_1.eContents().get(1);
		...
		//"fixed"
		public Keyword getFixedKeyword_1_0() { return cFixedKeyword_1_0; }
		
		//VALUE
		public RuleCall getVALUETerminalRuleCall_1_1() { return cVALUETerminalRuleCall_1_1; }
	}
	public class UfixedElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.Ufixed");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cUfixedKeyword_0 = (Keyword)cAlternatives.eContents().get(0);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Keyword cUfixedKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final RuleCall cVALUETerminalRuleCall_1_1 = (RuleCall)cGroup_1.eContents().get(1);
		...
		//"ufixed"
		public Keyword getUfixedKeyword_0() { return cUfixedKeyword_0; }
		
		//"ufixed" VALUE
		public Group getGroup_1() { return cGroup_1; }
		
		//"ufixed"
		public Keyword getUfixedKeyword_1_0() { return cUfixedKeyword_1_0; }
	...
	public class LocationLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.LocationLiteral");
		private final Assignment cTypeAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cTypeAlternatives_0 = (Alternatives)cTypeAssignment.eContents().get(0);
	...
	public class VisibilityLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.VisibilityLiteral");
		private final Assignment cTypeAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cTypeAlternatives_0 = (Alternatives)cTypeAssignment.eContents().get(0);
	...
	public class StateMutabilityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.StateMutability");
		private final Assignment cTypeAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cTypeAlternatives_0 = (Alternatives)cTypeAssignment.eContents().get(0);
		private final Keyword cTypePureKeyword_0_0 = (Keyword)cTypeAlternatives_0.eContents().get(0);
		private final Keyword cTypeViewKeyword_0_1 = (Keyword)cTypeAlternatives_0.eContents().get(1);
		private final Keyword cTypePayableKeyword_0_2 = (Keyword)cTypeAlternatives_0.eContents().get(2);
		...
		//"pure"
		public Keyword getTypePureKeyword_0_0() { return cTypePureKeyword_0_0; }
		
		//"view"
		public Keyword getTypeViewKeyword_0_1() { return cTypeViewKeyword_0_1; }
		
		//"payable"
		public Keyword getTypePayableKeyword_0_2() { return cTypePayableKeyword_0_2; }
	}
	...
	private final VersionOperatorElements pVersionOperator;
	...
	private final ConstructorDefinitionElements pConstructorDefinition;
	...
	private final EmitStatementElements pEmitStatement;
	...
	private final SizedDeclarationElements pSizedDeclaration;
	private final SimpleTypeDeclarationElements pSimpleTypeDeclaration;
	private final FixedElements pFixed;
	private final UfixedElements pUfixed;
	private final TerminalRule tVALUE;
	private final MapLocationLiteralElements pMapLocationLiteral;
	private final LocationLiteralElements pLocationLiteral;
	private final VisibilityLiteralElements pVisibilityLiteral;
	private final StateMutabilityElements pStateMutability;
	...
	public OptGrammarGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pVersionOperator = new VersionOperatorElements();
		...
		this.pConstructorDefinition = new ConstructorDefinitionElements();
		...
		this.pEmitStatement = new EmitStatementElements();
		...
		this.pSizedDeclaration = new SizedDeclarationElements();
		this.pSimpleTypeDeclaration = new SimpleTypeDeclarationElements();
		this.pFixed = new FixedElements();
		this.pUfixed = new UfixedElements();
		this.tVALUE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.unicam.myGrammar.OptGrammar.VALUE");
		this.pMapLocationLiteral = new MapLocationLiteralElements();
		this.pLocationLiteral = new LocationLiteralElements();
		this.pVisibilityLiteral = new VisibilityLiteralElements();
		this.pStateMutability = new StateMutabilityElements();
	...
	//	"constructor" parameters=ParameterList (state+=StateMutability | const+=Const | modifier+=ModifierInvocation |
	//	visibility+=VisibilityLiteral)* (block=Body | ";");
	public ConstructorDefinitionElements getConstructorDefinitionAccess() {
		return pConstructorDefinition;
	}
	
	public ParserRule getConstructorDefinitionRule() {
		return getConstructorDefinitionAccess().getRule();
	}
	...
	//	// Other
	//	"address" | "real" | "ureal" | Fixed | Ufixed);
	public SizedDeclarationElements getSizedDeclarationAccess() {
		return pSizedDeclaration;
	}
	
	public ParserRule getSizedDeclarationRule() {
		return getSizedDeclarationAccess().getRule();
	}
	...
	//Ufixed:
	//	"ufixed" | "ufixed" VALUE;
	public UfixedElements getUfixedAccess() {
		return pUfixed;
	}
	
	public ParserRule getUfixedRule() {
		return getUfixedAccess().getRule();
	}
	...
	//LocationLiteral:
	//	type=("memory" | MapLocationLiteral | "calldata");
	public LocationLiteralElements getLocationLiteralAccess() {
		return pLocationLiteral;
	}
	
	public ParserRule getLocationLiteralRule() {
		return getLocationLiteralAccess().getRule();
	}
	
	//VisibilityLiteral:
	//	type=("public" | "internal" | "private" | "external");
	public VisibilityLiteralElements getVisibilityLiteralAccess() {
		return pVisibilityLiteral;
	}
	
	public ParserRule getVisibilityLiteralRule() {
		return getVisibilityLiteralAccess().getRule();
	}
	
	//StateMutability:
	//	type=("pure" | "view" | "payable");
	public StateMutabilityElements getStateMutabilityAccess() {
		return pStateMutability;
	}
	
	public ParserRule getStateMutabilityRule() {
		return getStateMutabilityAccess().getRule();
	}
