...
public class InternalOptGrammarLexer extends Lexer {
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9798:10: ( '0x' ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+ )
            // InternalOptGrammar.g:9798:12: '0x' ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
            {
            match("0x"); 

            // InternalOptGrammar.g:9798:17: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9800:14: ( RULE_INT '.' RULE_INT )
            // InternalOptGrammar.g:9800:16: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mRULE_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9802:12: ( 'block.' ( 'coinbase' | 'difficulty' | 'gaslimit' | 'number' | 'timestamp' ) )
            // InternalOptGrammar.g:9802:14: 'block.' ( 'coinbase' | 'difficulty' | 'gaslimit' | 'number' | 'timestamp' )
            {
            match("block."); 

            // InternalOptGrammar.g:9802:23: ( 'coinbase' | 'difficulty' | 'gaslimit' | 'number' | 'timestamp' )
            int alt2=5;
            switch ( input.LA(1) ) {
            case 'c':
                {
            ...
            switch (alt2) {
                case 1 :
                    // InternalOptGrammar.g:9802:24: 'coinbase'
                    {
                    match("coinbase"); 
                    ...
                    break;
                case 2 :
                    // InternalOptGrammar.g:9802:35: 'difficulty'
                    {
                    match("difficulty"); 
                    ...
                    break;
                case 3 :
                    // InternalOptGrammar.g:9802:48: 'gaslimit'
                    {
                    match("gaslimit"); 
                    ...
                    break;
                case 4 :
                    // InternalOptGrammar.g:9802:59: 'number'
                    {
                    match("number"); 
                    ...
                    break;
                case 5 :
                    // InternalOptGrammar.g:9802:68: 'timestamp'
                    {
                    match("timestamp"); 
    ...
    public final void mRULE_MSG() throws RecognitionException {
        try {
            int _type = RULE_MSG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9804:10: ( 'msg.' ( 'data' | 'gas' | 'sender' | 'sig' | 'value' ) )
            // InternalOptGrammar.g:9804:12: 'msg.' ( 'data' | 'gas' | 'sender' | 'sig' | 'value' )
            {
            match("msg."); 

            // InternalOptGrammar.g:9804:19: ( 'data' | 'gas' | 'sender' | 'sig' | 'value' )
            int alt3=5;
            switch ( input.LA(1) ) {
            case 'd':
                {
            ...
            switch (alt3) {
                case 1 :
                    // InternalOptGrammar.g:9804:20: 'data'
                    {
                    match("data"); 
                    ...
                    break;
                case 2 :
                    // InternalOptGrammar.g:9804:27: 'gas'
                    {
                    match("gas"); 
                    ...
                    break;
                case 3 :
                    // InternalOptGrammar.g:9804:33: 'sender'
                    {
                    match("sender"); 
                    ...
                    break;
                case 4 :
                    // InternalOptGrammar.g:9804:42: 'sig'
                    {
                    match("sig"); 
                    ...
                    break;
                case 5 :
                    // InternalOptGrammar.g:9804:48: 'value'
                    {
                    match("value"); 
    ...
    public final void mRULE_TX() throws RecognitionException {
        try {
            int _type = RULE_TX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9806:9: ( 'tx.' ( 'gasprice' | 'origin' ) )
            // InternalOptGrammar.g:9806:11: 'tx.' ( 'gasprice' | 'origin' )
            {
            match("tx."); 

            // InternalOptGrammar.g:9806:17: ( 'gasprice' | 'origin' )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalOptGrammar.g:9806:18: 'gasprice'
                    {
                    match("gasprice"); 
                    ...
                    break;
                case 2 :
                    // InternalOptGrammar.g:9806:29: 'origin'
                    {
                    match("origin"); 
    ...
    public final void mRULE_NOW() throws RecognitionException {
        try {
            int _type = RULE_NOW;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9808:10: ( 'now' )
            // InternalOptGrammar.g:9808:12: 'now'
            {
            match("now"); 
    ...
    public final void mRULE_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9810:12: ( '0' .. '9' 'x' '0' .. '9' )
            // InternalOptGrammar.g:9810:14: '0' .. '9' 'x' '0' .. '9'
            {
            matchRange('0','9'); 
            match('x'); 
            matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9812:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalOptGrammar.g:9812:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalOptGrammar.g:9812:11: ( '^' )?
            int alt5=2;
            ...
            // InternalOptGrammar.g:9812:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9814:10: ( ( '0' .. '9' )+ )
            // InternalOptGrammar.g:9814:12: ( '0' .. '9' )+
            {
            // InternalOptGrammar.g:9814:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalOptGrammar.g:9814:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9816:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalOptGrammar.g:9816:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalOptGrammar.g:9816:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalOptGrammar.g:9816:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalOptGrammar.g:9816:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalOptGrammar.g:9816:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalOptGrammar.g:9816:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9818:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalOptGrammar.g:9818:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalOptGrammar.g:9818:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9820:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalOptGrammar.g:9820:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalOptGrammar.g:9820:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
            ...
            // InternalOptGrammar.g:9820:40: ( ( '\\r' )? '\\n' )?
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalOptGrammar.g:9820:41: ( '\\r' )? '\\n'
                    {
                    // InternalOptGrammar.g:9820:41: ( '\\r' )?
                    int alt13=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9822:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalOptGrammar.g:9822:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalOptGrammar.g:9822:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOptGrammar.g:9824:16: ( . )
            // InternalOptGrammar.g:9824:18: .
            {
            matchAny(); 
