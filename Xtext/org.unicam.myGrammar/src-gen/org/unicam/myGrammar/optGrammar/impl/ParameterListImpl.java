...
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
   ...
   * @ordered
   */
  protected EList<PrimaryTypeDefinitionDeclaration> parameters;
   ...
   */
  @Override
  public EList<PrimaryTypeDefinitionDeclaration> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<PrimaryTypeDefinitionDeclaration>(PrimaryTypeDefinitionDeclaration.class, this, OptGrammarPackage.PARAMETER_LIST__PARAMETERS);
    }
    return parameters;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case OptGrammarPackage.PARAMETER_LIST__PARAMETERS:
        getParameters().clear();
        getParameters().addAll((Collection<? extends PrimaryTypeDefinitionDeclaration>)newValue);
        return;
    }
