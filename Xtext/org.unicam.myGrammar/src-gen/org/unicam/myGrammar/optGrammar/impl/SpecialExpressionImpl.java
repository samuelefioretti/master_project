 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.myGrammar.optGrammar.impl.SpecialExpressionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.unicam.myGrammar.optGrammar.impl.SpecialExpressionImpl#getFieldOrMethod <em>Field Or Method</em>}</li>
 *   <li>{@link org.unicam.myGrammar.optGrammar.impl.SpecialExpressionImpl#getQualifiers <em>Qualifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecialExpressionImpl extends ExpressionImpl implements SpecialExpression
{
  ...
  public void setType(SpecialExpressionTypeEnum newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OptGrammarPackage.SPECIAL_EXPRESSION__TYPE, oldType, type));
  }
  ...
  public NotificationChain basicSetFieldOrMethod(Field newFieldOrMethod, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OptGrammarPackage.SPECIAL_EXPRESSION__FIELD_OR_METHOD, oldFieldOrMethod, newFieldOrMethod);
  ...
  public void setFieldOrMethod(Field newFieldOrMethod)
  {
    if (newFieldOrMethod != fieldOrMethod)
    {
      ...
      if (fieldOrMethod != null)
        msgs = ((InternalEObject)fieldOrMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OptGrammarPackage.SPECIAL_EXPRESSION__FIELD_OR_METHOD, null, msgs);
      if (newFieldOrMethod != null)
        msgs = ((InternalEObject)newFieldOrMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OptGrammarPackage.SPECIAL_EXPRESSION__FIELD_OR_METHOD, null, msgs);
      msgs = basicSetFieldOrMethod(newFieldOrMethod, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OptGrammarPackage.SPECIAL_EXPRESSION__FIELD_OR_METHOD, newFieldOrMethod, newFieldOrMethod));
  }
  ...
  public EList<Qualifier> getQualifiers()
  {
    if (qualifiers == null)
    {
      qualifiers = new EObjectContainmentEList<Qualifier>(Qualifier.class, this, OptGrammarPackage.SPECIAL_EXPRESSION__QUALIFIERS);
    }
    return qualifiers;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OptGrammarPackage.SPECIAL_EXPRESSION__FIELD_OR_METHOD:
        return basicSetFieldOrMethod(null, msgs);
      case OptGrammarPackage.SPECIAL_EXPRESSION__QUALIFIERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OptGrammarPackage.SPECIAL_EXPRESSION__TYPE:
        return getType();
      case OptGrammarPackage.SPECIAL_EXPRESSION__FIELD_OR_METHOD:
