 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.myGrammar.optGrammar.impl.ContractOrLibraryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.unicam.myGrammar.optGrammar.impl.ContractOrLibraryImpl#getInheritanceSpecifiers <em>Inheritance Specifiers</em>}</li>
 *   <li>{@link org.unicam.myGrammar.optGrammar.impl.ContractOrLibraryImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractOrLibraryImpl extends MinimalEObjectImpl.Container implements ContractOrLibrary
{
  ...
  {
    return OptGrammarPackage.eINSTANCE.getContractOrLibrary();
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OptGrammarPackage.CONTRACT_OR_LIBRARY__NAME, oldName, name));
  }
  ...
  public EList<InheritanceSpecifier> getInheritanceSpecifiers()
  {
    ...
    {
      inheritanceSpecifiers = new EObjectContainmentEList<InheritanceSpecifier>(InheritanceSpecifier.class, this, OptGrammarPackage.CONTRACT_OR_LIBRARY__INHERITANCE_SPECIFIERS);
    }
  ...
  public NotificationChain basicSetBody(DefinitionBody newBody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OptGrammarPackage.CONTRACT_OR_LIBRARY__BODY, oldBody, newBody);
  ...
  public void setBody(DefinitionBody newBody)
  {
    if (newBody != body)
    {
      ...
      if (body != null)
        msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OptGrammarPackage.CONTRACT_OR_LIBRARY__BODY, null, msgs);
      if (newBody != null)
        msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OptGrammarPackage.CONTRACT_OR_LIBRARY__BODY, null, msgs);
      msgs = basicSetBody(newBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OptGrammarPackage.CONTRACT_OR_LIBRARY__BODY, newBody, newBody));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OptGrammarPackage.CONTRACT_OR_LIBRARY__INHERITANCE_SPECIFIERS:
        return ((InternalEList<?>)getInheritanceSpecifiers()).basicRemove(otherEnd, msgs);
      case OptGrammarPackage.CONTRACT_OR_LIBRARY__BODY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OptGrammarPackage.CONTRACT_OR_LIBRARY__NAME:
        return getName();
      case OptGrammarPackage.CONTRACT_OR_LIBRARY__INHERITANCE_SPECIFIERS:
