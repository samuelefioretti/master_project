  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case OptGrammarPackage.PRIMARY_TYPE_DEFINITION_DECLARATION:
      {
        ...
        if (result == null) result = caseDefinitionBody(primaryTypeDefinitionDeclaration);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OptGrammarPackage.PRIMARY_TYPE_DECLARATION:
      {
        ...
        if (result == null) result = caseDefinitionBody(primaryTypeDeclaration);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OptGrammarPackage.NON_ARRAYABLE_DECLARATION:
      {
        ...
        if (result == null) result = caseDefinitionBody(nonArrayableDeclaration);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OptGrammarPackage.ARRAYABLE_DECLARATION:
      {
        ...
        if (result == null) result = caseDefinitionBody(arrayableDeclaration);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
