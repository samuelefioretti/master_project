...
public class TryGrammarSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == TryGrammarPackage.eINSTANCE)
	...
	protected void sequence_AddSub(ISerializationContext context, AddSub semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAddSub_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAddSub_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAddSub_AdditionOp()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAddSub_AdditionOp()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAddSub_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAddSub_Right()));
		}
	...
	protected void sequence_And(ISerializationContext context, And semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAnd_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAnd_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAnd_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAnd_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Arguments(ISerializationContext context, Arguments semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getArguments_Arguments()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getArguments_Arguments()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Assignment(ISerializationContext context, Assignment semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAssignment_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAssignment_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAssignment_AssignmentOp()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAssignment_AssignmentOp()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getAssignment_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getAssignment_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BinaryNotExpression(ISerializationContext context, BinaryNotExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBinaryNotExpression_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBinaryNotExpression_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BitAnd(ISerializationContext context, BitAnd semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBitAnd_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBitAnd_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBitAnd_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBitAnd_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BitOr(ISerializationContext context, BitOr semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBitOr_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBitOr_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBitOr_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBitOr_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BitXor(ISerializationContext context, BitXor semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBitXor_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBitXor_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBitXor_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBitXor_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BooleanConst(ISerializationContext context, BooleanConst semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getBooleanConst_Value()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getBooleanConst_Value()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Comparison(ISerializationContext context, Comparison semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getComparison_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getComparison_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getComparison_ComparisonOp()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getComparison_ComparisonOp()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getComparison_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getComparison_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_DeleteStatement(ISerializationContext context, DeleteStatement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getDeleteStatement_Variable()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getDeleteStatement_Variable()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ElementaryType(ISerializationContext context, ElementaryType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getElementaryType_Name()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getElementaryType_Name()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_EnumValue(ISerializationContext context, EnumValue semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getEnumValue_Name()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getEnumValue_Name()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Equality(ISerializationContext context, Equality semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getEquality_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getEquality_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getEquality_EqualityOp()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getEquality_EqualityOp()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getEquality_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getEquality_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Ether(ISerializationContext context, Ether semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getEther_Value()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getEther_Value()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getEther_Ether()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getEther_Ether()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Exponent(ISerializationContext context, Exponent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getExponent_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getExponent_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getExponent_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getExponent_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ExpressionStatement(ISerializationContext context, ExpressionStatement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getExpressionStatement_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getExpressionStatement_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ExpressionStatement_SimpleStatement(ISerializationContext context, ExpressionStatement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getExpressionStatement_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getExpressionStatement_Expression()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getExpressionStatement_Semicolon()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getExpressionStatement_Semicolon()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getExpressionStatementAccess().getExpressionExpressionParserRuleCall_0(), semanticObject.getExpression());
	...
	protected void sequence_Field(ISerializationContext context, Field semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getField_Field()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getField_Field()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_FunctionCallArg(ISerializationContext context, FunctionCallArg semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getFunctionCallArg_Name()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getFunctionCallArg_Name()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getFunctionCallArg_Expr()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getFunctionCallArg_Expr()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_LocationSpecifier(ISerializationContext context, LocationSpecifier semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getLocationSpecifier_Location()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getLocationSpecifier_Location()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Mapping(ISerializationContext context, Mapping semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getMapping_KeyType()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getMapping_KeyType()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getMapping_ValueType()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getMapping_ValueType()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *
	 * Constraint:
	 *     (name=ID parameters=ParameterList? block=Block)
	 */
	...
	protected void sequence_MulDivMod(ISerializationContext context, MulDivMod semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getMulDivMod_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getMulDivMod_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getMulDivMod_MultipliciativeOp()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getMulDivMod_MultipliciativeOp()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getMulDivMod_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getMulDivMod_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_NewExpression(ISerializationContext context, NewExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getNewExpression_Contract()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getNewExpression_Contract()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getNewExpression_Args()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getNewExpression_Args()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNewExpressionAccess().getContractContractOrLibraryIDTerminalRuleCall_1_0_1(), semanticObject.eGet(TryGrammarPackage.eINSTANCE.getNewExpression_Contract(), false));
	...
	protected void sequence_NotExpression(ISerializationContext context, NotExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getNotExpression_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getNotExpression_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_NumberDimensionless(ISerializationContext context, NumberDimensionless semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getNumberDimensionless_Value()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getNumberDimensionless_Value()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Or(ISerializationContext context, Or semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getOr_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getOr_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getOr_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getOr_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_PostIncDecExpression(ISerializationContext context, PostIncDecExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getPostIncDecExpression_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getPostIncDecExpression_Expression()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getPostIncDecExpression_PostOp()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getPostIncDecExpression_PostOp()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_PreDecExpression(ISerializationContext context, PreDecExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getPreDecExpression_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getPreDecExpression_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_PreExpression(ISerializationContext context, PreIncExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getPreIncExpression_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getPreIncExpression_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Shift(ISerializationContext context, Shift semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getShift_Left()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getShift_Left()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getShift_ShiftOp()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getShift_ShiftOp()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getShift_Right()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getShift_Right()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_SimpleStatement2(ISerializationContext context, VarVariableTupleVariableDeclaration semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Tuple()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Tuple()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_SimpleStatement2(ISerializationContext context, VarVariableTypeDeclaration semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Variable()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Variable()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_SimpleStatement(ISerializationContext context, VarVariableTupleVariableDeclaration semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Expression()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Semicolon()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTupleVariableDeclaration_Semicolon()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_SimpleStatement(ISerializationContext context, VarVariableTypeDeclaration semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Expression()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Semicolon()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVarVariableTypeDeclaration_Semicolon()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_StringLiteral(ISerializationContext context, StringLiteral semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getStringLiteral_Value()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getStringLiteral_Value()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Time(ISerializationContext context, Time semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getTime_Value()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getTime_Value()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getTime_Time()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getTime_Time()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_TypeCast(ISerializationContext context, TypeCast semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getTypeCast_Value()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getTypeCast_Value()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getTypeCast_Expression()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getTypeCast_Expression()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Type(ISerializationContext context, Type semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getType_IsVarType()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getType_IsVarType()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Variable(ISerializationContext context, Variable semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVariable_Name()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVariable_Name()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_VisibilitySpecifier(ISerializationContext context, VisibilitySpecifier semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getVisibilitySpecifier_Visibility()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getVisibilitySpecifier_Visibility()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_WhileStatement(ISerializationContext context, WhileStatement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getWhileStatement_Condition()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getWhileStatement_Condition()));
			if (transientValues.isValueTransient(semanticObject, TryGrammarPackage.eINSTANCE.getWhileStatement_Body()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TryGrammarPackage.eINSTANCE.getWhileStatement_Body()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
