...
public class TryGrammarSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TryGrammarGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (TryGrammarGrammarAccess) access;
