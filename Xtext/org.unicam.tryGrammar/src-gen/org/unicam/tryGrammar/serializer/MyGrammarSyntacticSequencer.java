...
public class MyGrammarSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MyGrammarGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MyGrammarGrammarAccess) access;
