 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryGrammar.tryGrammar.impl.QualifiedIdentifierImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.unicam.tryGrammar.tryGrammar.impl.QualifiedIdentifierImpl#getQualifiers <em>Qualifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QualifiedIdentifierImpl extends StandardTypeImpl implements QualifiedIdentifier
{
  ...
  {
    return TryGrammarPackage.eINSTANCE.getQualifiedIdentifier();
  }
  ...
  public void setIdentifier(String newIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TryGrammarPackage.QUALIFIED_IDENTIFIER__IDENTIFIER, oldIdentifier, identifier));
  }
  ...
  public EList<Qualifier> getQualifiers()
  {
    if (qualifiers == null)
    {
      qualifiers = new EObjectContainmentEList<Qualifier>(Qualifier.class, this, TryGrammarPackage.QUALIFIED_IDENTIFIER__QUALIFIERS);
    }
    return qualifiers;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TryGrammarPackage.QUALIFIED_IDENTIFIER__QUALIFIERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TryGrammarPackage.QUALIFIED_IDENTIFIER__IDENTIFIER:
