 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryGrammar.tryGrammar.impl.NewExpressionImpl#getContract <em>Contract</em>}</li>
 *   <li>{@link org.unicam.tryGrammar.tryGrammar.impl.NewExpressionImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NewExpressionImpl extends ExpressionImpl implements NewExpression
{
  ...
  {
    return TryGrammarPackage.eINSTANCE.getNewExpression();
  }
    ...
    if (contract != null && contract.eIsProxy())
    {
      ...
      if (contract != oldContract)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TryGrammarPackage.NEW_EXPRESSION__CONTRACT, oldContract, contract));
      }
    }
    return contract;
  }
  ...
  public void setContract(ContractOrLibrary newContract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TryGrammarPackage.NEW_EXPRESSION__CONTRACT, oldContract, contract));
  }
  ...
  public NotificationChain basicSetArgs(FunctionCallListArguments newArgs, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TryGrammarPackage.NEW_EXPRESSION__ARGS, oldArgs, newArgs);
  ...
  public void setArgs(FunctionCallListArguments newArgs)
  {
    if (newArgs != args)
    {
      ...
      if (args != null)
        msgs = ((InternalEObject)args).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TryGrammarPackage.NEW_EXPRESSION__ARGS, null, msgs);
      if (newArgs != null)
        msgs = ((InternalEObject)newArgs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TryGrammarPackage.NEW_EXPRESSION__ARGS, null, msgs);
      msgs = basicSetArgs(newArgs, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TryGrammarPackage.NEW_EXPRESSION__ARGS, newArgs, newArgs));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TryGrammarPackage.NEW_EXPRESSION__ARGS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TryGrammarPackage.NEW_EXPRESSION__CONTRACT:
