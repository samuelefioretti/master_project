 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryGrammar.tryGrammar.impl.ParameterListImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
  ...
  {
    return TryGrammarPackage.eINSTANCE.getParameterList();
  }
  ...
  public EList<Statement> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<Statement>(Statement.class, this, TryGrammarPackage.PARAMETER_LIST__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TryGrammarPackage.PARAMETER_LIST__PARAMETERS:
