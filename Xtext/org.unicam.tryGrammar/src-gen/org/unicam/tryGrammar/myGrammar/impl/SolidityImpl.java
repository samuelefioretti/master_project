 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.SolidityImpl#getImportDirective <em>Import Directive</em>}</li>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.SolidityImpl#getContract <em>Contract</em>}</li>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.SolidityImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolidityImpl extends MinimalEObjectImpl.Container implements Solidity
{
  ...
  {
    return MyGrammarPackage.eINSTANCE.getSolidity();
  }
  ...
  public EList<ImportDirective> getImportDirective()
  {
    ...
    {
      importDirective = new EObjectContainmentEList<ImportDirective>(ImportDirective.class, this, MyGrammarPackage.SOLIDITY__IMPORT_DIRECTIVE);
    }
  ...
  public EList<Contract> getContract()
  {
    if (contract == null)
    {
      contract = new EObjectContainmentEList<Contract>(Contract.class, this, MyGrammarPackage.SOLIDITY__CONTRACT);
    }
    return contract;
  }
  ...
  public EList<Library> getLibrary()
  {
    if (library == null)
    {
      library = new EObjectContainmentEList<Library>(Library.class, this, MyGrammarPackage.SOLIDITY__LIBRARY);
    }
    return library;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyGrammarPackage.SOLIDITY__IMPORT_DIRECTIVE:
        return ((InternalEList<?>)getImportDirective()).basicRemove(otherEnd, msgs);
      case MyGrammarPackage.SOLIDITY__CONTRACT:
        return ((InternalEList<?>)getContract()).basicRemove(otherEnd, msgs);
      case MyGrammarPackage.SOLIDITY__LIBRARY:
