 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.ParameterListImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
  ...
  {
    return MyGrammarPackage.eINSTANCE.getParameterList();
  }
  ...
  public EList<Statement> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<Statement>(Statement.class, this, MyGrammarPackage.PARAMETER_LIST__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyGrammarPackage.PARAMETER_LIST__PARAMETERS:
