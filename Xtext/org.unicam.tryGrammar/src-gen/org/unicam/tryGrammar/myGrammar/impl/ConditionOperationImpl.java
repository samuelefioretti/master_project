 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.ConditionOperationImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.ConditionOperationImpl#getNegateSecond <em>Negate Second</em>}</li>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.ConditionOperationImpl#getSeconds <em>Seconds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionOperationImpl extends MinimalEObjectImpl.Container implements ConditionOperation
{
  ...
  {
    return MyGrammarPackage.eINSTANCE.getConditionOperation();
  }
  ...
  public void setOperation(LogicalOperationLiteral newOperation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyGrammarPackage.CONDITION_OPERATION__OPERATION, oldOperation, operation));
  }
  ...
  public void setNegateSecond(String newNegateSecond)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyGrammarPackage.CONDITION_OPERATION__NEGATE_SECOND, oldNegateSecond, negateSecond));
  }
  ...
  public NotificationChain basicSetSeconds(Literal newSeconds, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyGrammarPackage.CONDITION_OPERATION__SECONDS, oldSeconds, newSeconds);
  ...
  public void setSeconds(Literal newSeconds)
  {
    if (newSeconds != seconds)
    {
      ...
      if (seconds != null)
        msgs = ((InternalEObject)seconds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyGrammarPackage.CONDITION_OPERATION__SECONDS, null, msgs);
      if (newSeconds != null)
        msgs = ((InternalEObject)newSeconds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyGrammarPackage.CONDITION_OPERATION__SECONDS, null, msgs);
      msgs = basicSetSeconds(newSeconds, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyGrammarPackage.CONDITION_OPERATION__SECONDS, newSeconds, newSeconds));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyGrammarPackage.CONDITION_OPERATION__SECONDS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyGrammarPackage.CONDITION_OPERATION__OPERATION:
        return getOperation();
      case MyGrammarPackage.CONDITION_OPERATION__NEGATE_SECOND:
