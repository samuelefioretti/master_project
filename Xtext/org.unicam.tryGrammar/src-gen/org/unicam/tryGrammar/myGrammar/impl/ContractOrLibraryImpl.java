...
public class ContractOrLibraryImpl extends MinimalEObjectImpl.Container implements ContractOrLibrary
{
  ...
  {
    return MyGrammarPackage.eINSTANCE.getContractOrLibrary();
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyGrammarPackage.CONTRACT_OR_LIBRARY__NAME, oldName, name));
  }
