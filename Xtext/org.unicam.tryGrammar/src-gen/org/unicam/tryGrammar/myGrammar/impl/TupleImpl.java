 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryGrammar.myGrammar.impl.TupleImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleImpl extends ExpressionImpl implements Tuple
{
  ...
  {
    return MyGrammarPackage.eINSTANCE.getTuple();
  }
  ...
  public EList<Expression> getMembers()
  {
    if (members == null)
    {
      members = new EObjectContainmentEList<Expression>(Expression.class, this, MyGrammarPackage.TUPLE__MEMBERS);
    }
    return members;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyGrammarPackage.TUPLE__MEMBERS:
