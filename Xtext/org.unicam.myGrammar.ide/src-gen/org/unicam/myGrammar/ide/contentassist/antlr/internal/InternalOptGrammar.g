...
:
(
	{ before(grammarAccess.getInheritanceSpecifierAccess().getInheritanceSpecifierAction_0()); }
	()
	{ after(grammarAccess.getInheritanceSpecifierAccess().getInheritanceSpecifierAction_0()); }
)
;
finally {
	restoreStackSize(stackSize);
