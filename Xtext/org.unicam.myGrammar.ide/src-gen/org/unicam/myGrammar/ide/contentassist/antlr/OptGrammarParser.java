...
public class OptGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStatementAccess().getAlternatives_4(), "rule__Statement__Alternatives_4");
			...
			builder.put(grammarAccess.getPayableAccess().getGroup(), "rule__Payable__Group__0");
			builder.put(grammarAccess.getViewAccess().getGroup(), "rule__View__Group__0");
			builder.put(grammarAccess.getPureAccess().getGroup(), "rule__Pure__Group__0");
			...
			builder.put(grammarAccess.getWhileStructureAccess().getGroup(), "rule__WhileStructure__Group__0");
			builder.put(grammarAccess.getForStructureAccess().getGroup(), "rule__ForStructure__Group__0");
			...
			builder.put(grammarAccess.getContractAccess().getBodyAssignment_2(), "rule__Contract__BodyAssignment_2");
			...
			builder.put(grammarAccess.getWhileStructureAccess().getTypeAssignment_0(), "rule__WhileStructure__TypeAssignment_0");
			builder.put(grammarAccess.getWhileStructureAccess().getConditionAssignment_2(), "rule__WhileStructure__ConditionAssignment_2");
			builder.put(grammarAccess.getWhileStructureAccess().getBodyAssignment_4(), "rule__WhileStructure__BodyAssignment_4");
			builder.put(grammarAccess.getForStructureAccess().getTypeAssignment_0(), "rule__ForStructure__TypeAssignment_0");
			builder.put(grammarAccess.getForStructureAccess().getInitExpressionAssignment_2(), "rule__ForStructure__InitExpressionAssignment_2");
			builder.put(grammarAccess.getForStructureAccess().getConditionExpressionAssignment_4(), "rule__ForStructure__ConditionExpressionAssignment_4");
			builder.put(grammarAccess.getForStructureAccess().getLoopExpressionAssignment_6(), "rule__ForStructure__LoopExpressionAssignment_6");
			builder.put(grammarAccess.getForStructureAccess().getBodyAssignment_8(), "rule__ForStructure__BodyAssignment_8");
