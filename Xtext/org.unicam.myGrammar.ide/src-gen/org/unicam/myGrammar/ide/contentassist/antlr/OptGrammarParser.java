...
public class OptGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getElementaryTypeNameEnumAccess().getTypeAlternatives_3_0(), "rule__ElementaryTypeNameEnum__TypeAlternatives_3_0");
			...
			builder.put(grammarAccess.getMappingAccess().getLocationAssignment_0(), "rule__Mapping__LocationAssignment_0");
			builder.put(grammarAccess.getMappingAccess().getVisibilityAssignment_1(), "rule__Mapping__VisibilityAssignment_1");
			builder.put(grammarAccess.getMappingAccess().getKeyTypeAssignment_4(), "rule__Mapping__KeyTypeAssignment_4");
			builder.put(grammarAccess.getMappingAccess().getValueTypeAssignment_6(), "rule__Mapping__ValueTypeAssignment_6");
			builder.put(grammarAccess.getMappingAccess().getNameAssignment_8(), "rule__Mapping__NameAssignment_8");
			...
			builder.put(grammarAccess.getExpressionAccess().getFirstAssignment_0_0(), "rule__Expression__FirstAssignment_0_0");
			builder.put(grammarAccess.getExpressionAccess().getOperationsAssignment_0_1(), "rule__Expression__OperationsAssignment_0_1");
			builder.put(grammarAccess.getExpressionAccess().getNegateAssignment_1_0(), "rule__Expression__NegateAssignment_1_0");
			builder.put(grammarAccess.getExpressionAccess().getFirstAssignment_1_1(), "rule__Expression__FirstAssignment_1_1");
			builder.put(grammarAccess.getExpressionAccess().getOperationsAssignment_1_2(), "rule__Expression__OperationsAssignment_1_2");
			builder.put(grammarAccess.getExpressionAccess().getTernaryAssignment_2_0(), "rule__Expression__TernaryAssignment_2_0");
			builder.put(grammarAccess.getExpressionAccess().getFirstAssignment_2_1(), "rule__Expression__FirstAssignment_2_1");
			builder.put(grammarAccess.getExpressionAccess().getTrueAssignment_2_3(), "rule__Expression__TrueAssignment_2_3");
			builder.put(grammarAccess.getExpressionAccess().getFalseAssignment_2_5(), "rule__Expression__FalseAssignment_2_5");
			...
			builder.put(grammarAccess.getElementaryTypeNameEnumAccess().getTypeAssignment_0(), "rule__ElementaryTypeNameEnum__TypeAssignment_0");
