...
public class OptGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPragmaDirectiveAccess().getAlternatives(), "rule__PragmaDirective__Alternatives");
			...
			builder.put(grammarAccess.getPragmaDirectiveAccess().getGroup_0(), "rule__PragmaDirective__Group_0__0");
			builder.put(grammarAccess.getPragmaDirectiveAccess().getGroup_1(), "rule__PragmaDirective__Group_1__0");
			...
			builder.put(grammarAccess.getPragmaDirectiveAccess().getNameAssignment_0_1(), "rule__PragmaDirective__NameAssignment_0_1");
			builder.put(grammarAccess.getPragmaDirectiveAccess().getVersionAssignment_0_2(), "rule__PragmaDirective__VersionAssignment_0_2");
			builder.put(grammarAccess.getPragmaDirectiveAccess().getVersionliteralAssignment_0_3(), "rule__PragmaDirective__VersionliteralAssignment_0_3");
			builder.put(grammarAccess.getPragmaDirectiveAccess().getNameAssignment_1_2(), "rule__PragmaDirective__NameAssignment_1_2");
