...
public class OptGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFunctionDefinitionAccess().getVisibilityAssignment_4(), "rule__FunctionDefinition__VisibilityAssignment_4");
			...
			builder.put(grammarAccess.getMappingAccess().getNameAssignment_9(), "rule__Mapping__NameAssignment_9");
