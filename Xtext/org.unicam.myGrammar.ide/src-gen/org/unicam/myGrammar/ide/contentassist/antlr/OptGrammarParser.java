...
public class OptGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPragmaDirectiveAccess().getNameAssignment_1(), "rule__PragmaDirective__NameAssignment_1");
			builder.put(grammarAccess.getPragmaDirectiveAccess().getVersionAssignment_2(), "rule__PragmaDirective__VersionAssignment_2");
			builder.put(grammarAccess.getPragmaDirectiveAccess().getVersionliteralAssignment_3(), "rule__PragmaDirective__VersionliteralAssignment_3");
