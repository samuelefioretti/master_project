...
public class OptGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConstructorDefinitionAccess().getAlternatives_4(), "rule__ConstructorDefinition__Alternatives_4");
			...
			builder.put(grammarAccess.getConstructorDefinitionAccess().getNameAssignment_1(), "rule__ConstructorDefinition__NameAssignment_1");
			builder.put(grammarAccess.getConstructorDefinitionAccess().getParametersAssignment_2(), "rule__ConstructorDefinition__ParametersAssignment_2");
			builder.put(grammarAccess.getConstructorDefinitionAccess().getStateAssignment_3_0(), "rule__ConstructorDefinition__StateAssignment_3_0");
			builder.put(grammarAccess.getConstructorDefinitionAccess().getConstAssignment_3_1(), "rule__ConstructorDefinition__ConstAssignment_3_1");
			builder.put(grammarAccess.getConstructorDefinitionAccess().getModifierAssignment_3_2(), "rule__ConstructorDefinition__ModifierAssignment_3_2");
			builder.put(grammarAccess.getConstructorDefinitionAccess().getVisibilityAssignment_3_3(), "rule__ConstructorDefinition__VisibilityAssignment_3_3");
			builder.put(grammarAccess.getConstructorDefinitionAccess().getBlockAssignment_4_0(), "rule__ConstructorDefinition__BlockAssignment_4_0");
