...
:
	...
	|
	(
		{ before(grammarAccess.getNumberAccess().getNowParserRuleCall_2()); }
		ruleNow
		{ after(grammarAccess.getNumberAccess().getNowParserRuleCall_2()); }
	)
	|
	(
		{ before(grammarAccess.getNumberAccess().getTimeParserRuleCall_3()); }
		ruleTime
...
:
	(
		{ before(grammarAccess.getFunctionDefinitionAccess().getBlockBlockParserRuleCall_6_0_0()); }
		ruleBlock
		{ after(grammarAccess.getFunctionDefinitionAccess().getBlockBlockParserRuleCall_6_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getModifierAccess().getBlockBlockParserRuleCall_3_0()); }
		ruleBlock
		{ after(grammarAccess.getModifierAccess().getBlockBlockParserRuleCall_3_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getBlockAccess().getStatementsStatementParserRuleCall_2_1_0()); }
		ruleStatement
		{ after(grammarAccess.getBlockAccess().getStatementsStatementParserRuleCall_2_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
