...
:
	(
		{ before(grammarAccess.getFunctionDefinitionAccess().getBlockBlockParserRuleCall_7_0_0()); }
		ruleBlock
		{ after(grammarAccess.getFunctionDefinitionAccess().getBlockBlockParserRuleCall_7_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
