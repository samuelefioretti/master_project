...
import org.unicam.tryGrammar.ide.contentassist.antlr.internal.InternalTryGrammarParser;
import org.unicam.tryGrammar.services.TryGrammarGrammarAccess;

public class TryGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(TryGrammarGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TryGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBlockAccess().getStatementsAssignment_2_1(), "rule__Block__StatementsAssignment_2_1");
	...
	@Override
	protected InternalTryGrammarParser createParser() {
		InternalTryGrammarParser result = new InternalTryGrammarParser(null);
