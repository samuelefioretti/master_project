 ...
 */
package org.unicam.tryGrammar.ide.contentassist.antlr;
...
import org.unicam.tryGrammar.ide.contentassist.antlr.internal.InternalMyGrammarParser;
import org.unicam.tryGrammar.services.MyGrammarGrammarAccess;

public class MyGrammarParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MyGrammarGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyGrammarGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getContractAccess().getAlternatives_2(), "rule__Contract__Alternatives_2");
			...
			builder.put(grammarAccess.getContractAccess().getGroup_2_0(), "rule__Contract__Group_2_0__0");
			builder.put(grammarAccess.getLibraryAccess().getGroup(), "rule__Library__Group__0");
			builder.put(grammarAccess.getLibraryAccess().getGroup_2(), "rule__Library__Group_2__0");
			builder.put(grammarAccess.getLibraryAccess().getGroup_2_2(), "rule__Library__Group_2_2__0");
			...
			builder.put(grammarAccess.getEnumDefinitionAccess().getGroup_4(), "rule__EnumDefinition__Group_4__0");
			builder.put(grammarAccess.getEnumDefinitionAccess().getGroup_4_1(), "rule__EnumDefinition__Group_4_1__0");
			...
			builder.put(grammarAccess.getContractAccess().getBlocksAssignment_2_0_0(), "rule__Contract__BlocksAssignment_2_0_0");
			builder.put(grammarAccess.getContractAccess().getBlocksAssignment_2_1(), "rule__Contract__BlocksAssignment_2_1");
			builder.put(grammarAccess.getLibraryAccess().getNameAssignment_1(), "rule__Library__NameAssignment_1");
			builder.put(grammarAccess.getLibraryAccess().getInheritanceSpecifiersAssignment_2_1(), "rule__Library__InheritanceSpecifiersAssignment_2_1");
			builder.put(grammarAccess.getLibraryAccess().getInheritanceSpecifiersAssignment_2_2_1(), "rule__Library__InheritanceSpecifiersAssignment_2_2_1");
			builder.put(grammarAccess.getLibraryAccess().getBodyAssignment_3(), "rule__Library__BodyAssignment_3");
			...
			builder.put(grammarAccess.getEnumDefinitionAccess().getMembersAssignment_4_0(), "rule__EnumDefinition__MembersAssignment_4_0");
			builder.put(grammarAccess.getEnumDefinitionAccess().getMembersAssignment_4_1_1(), "rule__EnumDefinition__MembersAssignment_4_1_1");
			...
			builder.put(grammarAccess.getIntParameterAccess().getRefAssignment_0(), "rule__IntParameter__RefAssignment_0");
			builder.put(grammarAccess.getIntParameterAccess().getParamAssignment_1(), "rule__IntParameter__ParamAssignment_1");
			builder.put(grammarAccess.getIntParameterAccess().getFunAssignment_2(), "rule__IntParameter__FunAssignment_2");
	...
	@Override
	protected InternalMyGrammarParser createParser() {
		InternalMyGrammarParser result = new InternalMyGrammarParser(null);
