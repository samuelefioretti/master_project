...
public class TryIdeSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TryIdeGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (TryIdeGrammarAccess) access;
