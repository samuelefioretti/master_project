...
:
	...
	|
	(
		{ before(grammarAccess.getNumberAccess().getHexLiteralParserRuleCall_3()); }
		ruleHexLiteral
		{ after(grammarAccess.getNumberAccess().getHexLiteralParserRuleCall_3()); }
	)
	|
	(
		{ before(grammarAccess.getNumberAccess().getDecimalLiteralParserRuleCall_4()); }
		ruleDecimalLiteral
		{ after(grammarAccess.getNumberAccess().getDecimalLiteralParserRuleCall_4()); }
	)
	|
	(
		{ before(grammarAccess.getNumberAccess().getTimeParserRuleCall_5()); }
		ruleTime
		{ after(grammarAccess.getNumberAccess().getTimeParserRuleCall_5()); }
	)
;
finally {
	restoreStackSize(stackSize);
