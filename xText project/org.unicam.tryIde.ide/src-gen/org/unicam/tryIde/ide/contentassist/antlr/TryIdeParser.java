 ...
 */
package org.unicam.tryIde.ide.contentassist.antlr;
...
import org.unicam.tryIde.ide.contentassist.antlr.internal.InternalTryIdeParser;
import org.unicam.tryIde.services.TryIdeGrammarAccess;

public class TryIdeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(TryIdeGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TryIdeGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFunctionDefinitionAccess().getBlocksAssignment_6_0(), "rule__FunctionDefinition__BlocksAssignment_6_0");
			...
			builder.put(grammarAccess.getModifierAccess().getBlocksAssignment_3(), "rule__Modifier__BlocksAssignment_3");
			...
			builder.put(grammarAccess.getBlocksAccess().getStatementsAssignment_2_0(), "rule__Blocks__StatementsAssignment_2_0");
			builder.put(grammarAccess.getBlocksAccess().getStatementsAssignment_2_1(), "rule__Blocks__StatementsAssignment_2_1");
	...
	@Override
	protected InternalTryIdeParser createParser() {
		InternalTryIdeParser result = new InternalTryIdeParser(null);
