 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryIde.solidity.impl.TupleImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleImpl extends ExpressionImpl implements Tuple
{
  ...
  {
    return SolidityPackage.eINSTANCE.getTuple();
  }
  ...
  public EList<Expression> getMembers()
  {
    if (members == null)
    {
      members = new EObjectContainmentEList<Expression>(Expression.class, this, SolidityPackage.TUPLE__MEMBERS);
    }
    return members;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SolidityPackage.TUPLE__MEMBERS:
