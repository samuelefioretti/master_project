 ...
 * </p>
 * <ul>
 *   <li>{@link org.unicam.tryIde.solidity.impl.MappingImpl#getKeyType <em>Key Type</em>}</li>
 *   <li>{@link org.unicam.tryIde.solidity.impl.MappingImpl#getValueType <em>Value Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingImpl extends StandardTypeImpl implements Mapping
{
  ...
  {
    return SolidityPackage.eINSTANCE.getMapping();
  }
  ...
  public void setKeyType(ElementaryTypeNameEnum newKeyType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SolidityPackage.MAPPING__KEY_TYPE, oldKeyType, keyType));
  }
  ...
  public NotificationChain basicSetValueType(Type newValueType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SolidityPackage.MAPPING__VALUE_TYPE, oldValueType, newValueType);
  ...
  public void setValueType(Type newValueType)
  {
    if (newValueType != valueType)
    {
      ...
      if (valueType != null)
        msgs = ((InternalEObject)valueType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SolidityPackage.MAPPING__VALUE_TYPE, null, msgs);
      if (newValueType != null)
        msgs = ((InternalEObject)newValueType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SolidityPackage.MAPPING__VALUE_TYPE, null, msgs);
      msgs = basicSetValueType(newValueType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SolidityPackage.MAPPING__VALUE_TYPE, newValueType, newValueType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SolidityPackage.MAPPING__VALUE_TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SolidityPackage.MAPPING__KEY_TYPE:
        return getKeyType();
      case SolidityPackage.MAPPING__VALUE_TYPE:
        return getValueType();
    }
